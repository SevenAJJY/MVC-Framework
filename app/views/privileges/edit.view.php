        ...
        <div class="col-md-12 d-flex align-items-center justify-content-center">
            <div class="my-container">
                ...
                <form action="" class="appform" method="post" autocomplete="off"
                    ...
                    <div class="input-box">
                        <input type="text" spellcheck="false" name="PrivilegeTitle" maxlength="50"
                            value="<?php echo (isset($privilege)) ? $privilege->PrivilegeTitle : '' ; ?>" required />
                        <label for=""><?php echo $text_label_privilege_title ?></label>
                    </div>
                    <div class="input-box">
                        <input type="text" spellcheck="false" name="Privilege" maxlength="30"
                            value="<?php echo (isset($privilege)) ? $privilege->Privilege : '' ; ?>" required />
