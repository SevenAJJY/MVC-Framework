                        ...
                        <div class="col-md-4">
                            <div class="input-box">
                                <select class="form-select select-box " name="PaymentStatus" required>
                                    ...
                                    <option value="1" <?= $this->selectedIf('PaymentStatus' ,  1, $invoice);?>>
                                        <?= $text_payment_status_1 ?></option>
                                    <option value="2" <?= $this->selectedIf('PaymentStatus' ,  2, $invoice);?>>
                        ...
                        <div class="col-md-4">
                            <div class="input-box">
                                <select class="form-select select-box " name="Discount" required>
                                    ...
                                    <?php for($i = 1 ; $i < 100 ; $i++):?>
                                    <option value="<?= $i ?>" <?= $this->selectedIf('Discount', $i, $invoice)?>>
                                        <?= $i ?>
                                    </option>
                                    <?php endfor;?>
                                </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="productp[]" class="input-products" type="number" required
                                                min="0" step="0.01" value="<?= $detail->ProductPrice ?>">
                                            <input name="productv[]" class="input-products" type="hidden"
                                                value="<?= $detail->ProductId ?>">
                                        </td>
                                        <td>
                                            <a onclick="removeProduct(this);" href="javascript:void(0);"> <i
