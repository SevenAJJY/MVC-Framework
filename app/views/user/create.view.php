            ...
            <div class="my-container fuser">
                ...
                <form action="" class="appform row" method="POST" enctype="multipart/form-data" enctype="application/x-www-form-urlencoded">
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="input-box">
                            <input type="text" spellcheck="false" class="FirstName" name="name" id="FirstName" maxlength="10"  required>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="input-box">
                            <input type="number" spellcheck="false" class="Username" name="age" id="Username" maxlength="30"  required>
