        ...
        <div class="col-md-12 d-flex align-items-center justify-content-center">
            <div class="my-container fuser">
                ...
                <form action="" class="appform row" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="input-box">
                            <input type="text" spellcheck="false" name="address" id="LastName" maxlength="10"
                                value='<?= isset($user) ? $user->address : '' ?>' required>
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="input-box">
                            <input type="number" spellcheck="false" class="Username" name="age" id="Username"
                                maxlength="30" value='<?= isset($user) ? $user->age : '' ?>' required>
                            <label for="age" class="labelerror">age</label>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="input-box">
                            <input type="number" spellcheck="false" step="0.01" id="Number" name="salary"
                                value='<?= isset($user) ? $user->salary : '' ?>' required>
                            <label for="Number">Salary</label>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-sm-12">
                        <div class="input-box">
                            <input type="number" spellcheck="false" step="0.01" id="Number" name="tax"
                                value='<?= isset($user) ? $user->tax : '' ?>' required>
